...
window.GENESIS_TOKENS = {
  ...
  brands: {
    ...
    ciudadvirtual: {
      name: "Ciudad Virtual",
      tagline: "Ecosistema digital · membresías · experiencias conectadas.",
      voice: "Moderna, inteligente, cercana y dinámica. Premium accesible sin sentirse fría.",
      primary: "#24E0A7",
      primaryHover: "#1BC992",
      primaryPressed: "#13A978",
      primarySoft: "#E4FFF6",
      onPrimary: "#050706",
      accent: "#171A19",
      text: "#101413",
      ...
      fontDisplay: "'Nord', 'Inter Display', sans-serif",
      fontBody: "'Inter', sans-serif",
      fontMono: "'IBM Plex Mono', monospace",
      radiusSm: 4,
      radiusMd: 8,
